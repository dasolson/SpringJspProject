 ...
 *             | 자동 생성 X => 직접 폴더 생성 => JSP 보다는 ThymeLeaf 권장
 *          = Spring Boot 보다 Spring Framework가 많다
 ...
 *             => 일반 게시판    
  ...
  *          = 어떤 메소드에 적용 : PointCut
  *          	execution("* com.sist.web.*Controller.*(..)") = Controller로 끝나는 모든 메소드에 적용
  *                      ("* com.sist.web.MainController.main(.String)")
  *          = 메소드 호출 위치              
  *             public String aaa() {
  *             	--------------- @Before
  *             	try {
  ...
  *                             => 메소드 규칙 
  *                             => JOIN (관계) 1:N, N:M
  *                             => 개인 프로젝트에서 사용 예정 => Spring-Boot / JPA / MySQL
