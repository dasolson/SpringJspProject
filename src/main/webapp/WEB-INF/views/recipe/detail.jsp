				...
				<tbody>
					...
					<tr v-for="(data,index) in store.detail.tList">
						...
						<td class="text-right" width=15%>
							<img :src="store.detail.iList[index]" style="width: 180px;height: 100px">
						</td>
					</tr>
				</tbody>
			</table>
						...
						<tbody>
							...
							<tr>
								<td colspan="2" class="text-left" v-if="rStore.upReplyNo===rvo.no">
									...
									<button type="button" class="btn-success" style="width: 100px;height: 102px;float: left" @click="rStore.replyUpdate(rvo.no)">댓글수정</button>
								</td>
							</tr>
						</tbody>
					</table>
